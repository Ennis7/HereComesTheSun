namespace assignment8ex1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Program.Beatles beatlesObj = new Program.Beatles(HereComesTheSun.title);
                // adding methods to the delegate
            beatlesObj += HereComesTheSun.chorus;
            beatlesObj += HereComesTheSun.verse1;
            beatlesObj += HereComesTheSun.chorus;
            beatlesObj += HereComesTheSun.verse2;
            beatlesObj += HereComesTheSun.chorus2;
            beatlesObj += HereComesTheSun.verse3;
            beatlesObj += HereComesTheSun.chorus;
            beatlesObj += HereComesTheSun.chorus;
            beatlesObj += HereComesTheSun.end;
